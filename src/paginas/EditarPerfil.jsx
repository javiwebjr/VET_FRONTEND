...
const EditarPerfil = () => {
    ...
    return (
        <>
            ...
            <p className="text-xl mt-5 mb-10 text-center">Modifica tu {''} <span className="text-violet-vet font-bold">Informacion</span></p>
                ...
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="submit" value="Guardar Cambios"
                            className="bg-violet-vet px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5"
                        />
                    </form>
                </div>
            </div>
