...
const NuevoPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(password.length < 6){
      setAlerta({
        msg: 'Password demasiado corto, minimo de 6 caracteres',
        error: true
      })
      return;
    }
  ...
  return (
    <>
      <div>
          <h1 className="text-violet-vet font-black text-6xl">Reestablece tu password y no pierdas acceso a tus{" "}<span className="text-black">Pacientes</span>
          </h1>
      </div>
